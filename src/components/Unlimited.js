...
import '../styles/Unlimited.scss'

const Unlimited = () => {
  return (
    <div className='unlimited__container'>
        <h2 className='unlimited__header'>Unlimited, UNLIMITED, U-N-L-I-M-I-T-E-D</h2>
            <p className='unlimited__text'> 
            ...
            <a className='unlimited__text--link' href='#'>Check our other specials!</a>
            </p>
        <div className='unlimited__photo'></div>
    </div>
  )
}
